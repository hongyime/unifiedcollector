// @ts-nocheck — content.ts is the largest bundle entry (>4000 LOC). Per
// docs/plans/extension-bundler.md step 15 we keep bodies unchecked at the
// initial TS conversion so import shapes are strictly typed (validated by
// shared/*.ts) without blocking the rollout on a full-strict pass. A
// follow-up pass will remove @ts-nocheck file-by-file.
