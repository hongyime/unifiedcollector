...
- **Shared atomic artifact writer:** `src/core/vault.py::write_atomic_artifact`
  ...
  Telegram, WhatsApp, Lemon8, YouTube, and TikTok media downloads use this path for
...
- Physical-file dedupe now has a core sha256 blob writer, and Beeper, Telegram,
  WhatsApp, Lemon8, YouTube, and TikTok media downloads use it. Remaining
  Instagram, Website, Search, GitHub avatar/media, Strava photo/map, shared
  profile photo, and generic legacy helper paths still need source-by-source
