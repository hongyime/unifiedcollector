...
- **Shared atomic artifact writer:** `src/core/vault.py::write_atomic_artifact`
  ...
  Telegram, WhatsApp, Lemon8, YouTube, TikTok, and Website media
...
- Physical-file dedupe now has a core sha256 blob writer, and Beeper, Telegram,
  WhatsApp, Lemon8, YouTube, TikTok, and Website media downloads use it.
  Remaining Instagram, Search, GitHub avatar/media, Strava photo/map, shared
