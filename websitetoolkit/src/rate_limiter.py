"""
rate_limiter.py — Smart rate limiting with domain throttling for Website Toolkit.

Provides per-domain request throttling, exponential backoff on errors,
and Tor circuit rotation support.

Design inspired by FORGE's opsec patterns but simplified for Website Toolkit needs.
"""
...
class AdaptiveRateLimiter(RateLimiter):
    ...
    def record_success(self, url: str) -> None:
        ...
        with self._lock:
            ...
            # After 5 consecutive successes, try reducing delay
    ...
    def record_failure(self, url: str, status_code: int = 0) -> None:
        ...
        with self._lock:
            ...
            # Increase base delay for rate limit errors
