                ...
                if loaded_session_path:  # Only proceed if session wasn't removed due to age
                    try:
                        ...
                        if logged_in:
                            ...
                            # is_logged_in=True means the session cookie is valid — no extra API call needed.
                            # A redundant profile-lookup hit here triggers 429s when cycling all accounts.
